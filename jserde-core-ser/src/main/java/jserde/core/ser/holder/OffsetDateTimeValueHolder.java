...
/**
 * {@link DataValueHolder} that holds a {@link DataType#OFFSET_DATE_TIME}.
 *
 * @author Laurent Pireyn
 */
public final class OffsetDateTimeValueHolder extends DataValueHolder<OffsetDateTime> {
    ...
    @Override
    OffsetDateTime getValueInternal() {
        assert value != null;
        return value;
    }
}
