...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#LOCAL_DATE_TIME}.
 *
 * @author Laurent Pireyn
 */
public final class LocalDateTimeValueHolder extends DataValueHolder {
    private final LocalDateTime value;

    public LocalDateTimeValueHolder(LocalDateTime value) {
        this.value = value;
    }
