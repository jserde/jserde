...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#BIG_INTEGER}.
 *
 * @author Laurent Pireyn
 */
public final class BigIntegerValueHolder extends DataValueHolder {
    private final BigInteger value;

    public BigIntegerValueHolder(BigInteger value) {
        this.value = value;
    }
