...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#LOCAL_TIME}.
 *
 * @author Laurent Pireyn
 */
public final class LocalTimeValueHolder extends DataValueHolder {
    private final LocalTime value;

    public LocalTimeValueHolder(LocalTime value) {
        this.value = value;
    }
