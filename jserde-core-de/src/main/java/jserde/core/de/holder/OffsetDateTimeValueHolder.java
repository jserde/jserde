...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#OFFSET_DATE_TIME}.
 *
 * @author Laurent Pireyn
 */
public final class OffsetDateTimeValueHolder extends DataValueHolder {
    private final OffsetDateTime value;

    public OffsetDateTimeValueHolder(OffsetDateTime value) {
        this.value = value;
    }
