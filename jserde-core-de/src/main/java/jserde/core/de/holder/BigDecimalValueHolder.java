...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#BIG_DECIMAL}.
 *
 * @author Laurent Pireyn
 */
public final class BigDecimalValueHolder extends DataValueHolder {
    private final BigDecimal value;

    public BigDecimalValueHolder(BigDecimal value) {
        this.value = value;
    }
