...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#LOCAL_DATE}.
 *
 * @author Laurent Pireyn
 */
public final class LocalDateValueHolder extends DataValueHolder {
    private final LocalDate value;

    public LocalDateValueHolder(LocalDate value) {
        this.value = value;
    }
