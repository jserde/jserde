...
/**
 * {@link DataValueHolder} that holds a fixed {@link DataType#SHORT}.
 *
 * @author Laurent Pireyn
 */
public final class ShortValueHolder extends DataValueHolder {
    private final short value;

    public ShortValueHolder(short value) {
        this.value = value;
    }
